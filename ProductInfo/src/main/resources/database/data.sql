...
INSERT INTO discount VALUES (1,'Выгодное предложение', 'Скидка','PERCENT',10 );
INSERT INTO discount VALUES (2,'Сезонная скидка', 'Сезонная скидка','ABSOLUTE',10 );
INSERT INTO discount VALUES (3,'Распродажа', 'Распродажа','PERCENT',50 );
...
INSERT INTO product VALUES (2,'Деревенский хлеб','Ручное производство: от замешивания теста до упаковки.Чистый понятный состав:мука пшеничная,соль,сахар,дрожжи,сливочное масло натуральный мед.',66,'/',2,1);
