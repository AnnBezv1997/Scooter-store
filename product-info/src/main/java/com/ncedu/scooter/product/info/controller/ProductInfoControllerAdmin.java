...
public class ProductInfoControllerAdmin {
    ...
    public boolean createCategory(@RequestBody @Valid Category category) throws ExceptionCategory {
    ...
    public boolean createDiscount(@RequestBody @Valid Discount discount) {
    ...
    public boolean updateCategory(@RequestBody @Valid Category category){
       try {
           return categoryService.updateCategory(category);
       }catch (ExceptionCategory | ExceptionNotFound e){
           e.getMessage();
           return false;
       }
